...
const UserRoleRepository_1 = require("@app/repositories/UserRoleRepository");
...
let UserRoleService = class UserRoleService {
    ...
    async create(role) {
        ...
        this.eventDispatcher.dispatch(events_1.events.userRole.created, newUserRole);
        return newUserRole;
    }
    update(id, role) {
...
UserRoleService = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [UserRoleRepository_1.UserRoleRepository,
